...
$status_query = mysql_query("select * from Cronstatus where State='Queens' and Contenttype='CH' order by Id desc limit 1");
		...
		if(isset($info['http_code'])&&($info['http_code']==200))
		{
			...
			$insert_query_value = '';
			   ...
			   $i;
				...
				echo $insert_query = "insert into CH_Queens (	house_number,Street,Complaint_Date,Complaint,SR,Apt,Complaint_Condition,Condtion_Detail,Location,zipcode) VALUES ".$insert_query_value;
				//echo "==>".$insert_query;
