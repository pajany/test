...
$status_query = mysql_query("select * from Cronstatus where State='Bronx' and Contenttype = 'OPV' order by Id desc limit 1");
			...
			$insert_query_value = '';
			   ...
			   $i;
				...
				if($insert_query_value!='')
				{
				 ...
				 $insert_query = "insert into OPV_Bronx (house_number,Street,Apt_story,Reported_novIssuedDate,Hzrd_Class,Order_no,ViolationId_NovId,Violation_Description,Status_StatusDate,CertByDate_ActualCertDate,zipcode) VALUES ".$insert_query_value;
