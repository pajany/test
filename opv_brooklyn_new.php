...
$status_query = mysql_query("select * from Cronstatus where State='Brooklyn' and Contenttype = 'OPV' order by Id desc limit 1");
...
$today = date('Y-m-d');
$lastrowquery = "select Street,house_number,aid from Brooklyn order by aid desc limit 0,1";
...
$manhattan_query = "select aid,house_number,Street from Brooklyn $where_clause order by aid asc";
			...
			$insert_query_value = '';
			   ...
			   $i;
				...
				if($insert_query_value!='')
				{
				 ...
				 $insert_query = "insert into OPV_Brooklyn (house_number,Street,Apt_story,Reported_novIssuedDate,Hzrd_Class,Order_no,ViolationId_NovId,Violation_Description,Status_StatusDate,CertByDate_ActualCertDate,zipcode) VALUES ".$insert_query_value;
